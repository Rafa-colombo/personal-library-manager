...
🚀 **100% Nativo & Independente:** Este projeto foi construído **exclusivamente com a Standard Library do Python**. Nenhuma biblioteca externa (`pip install`) é necessária para rodar a aplicação.
